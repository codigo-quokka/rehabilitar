...
export function Button({
  ...
  const variants = {
    primary: "bg-primary text-white hover:bg-primary-dark focus:ring-primary dark:bg-dark-green dark:hover:bg-darkest-green dark:border-1 dark:border-gray-500",
