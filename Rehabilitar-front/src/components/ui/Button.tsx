...
export function Button({
  ...
  const variants = {
    ...
    naranja:"border border-gray-300 dark:border-gray-600 focus:ring-gray-300 dark:text-gray-100 bg-orange-200 hover:bg-orange-300 text-orange-700 dark:bg-amber-600 dark:hover:bg-amber-700",
