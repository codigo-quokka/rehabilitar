...
export function Button({
  ...
  const variants = {
    ...
    violeta:"border border-gray-300 dark:border-gray-600 focus:ring-gray-300 dark:text-gray-100 bg-violet-200 hover:bg-violet-300 text-violet-800 dark:bg-violet-900 dark:hover:bg-violet-950",
