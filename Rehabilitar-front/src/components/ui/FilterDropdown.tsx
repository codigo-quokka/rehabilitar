  ...
  return (
    <div ref={containerRef} className="relative flex items-center">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-dark dark:text-gray-100 text-base hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
      >
