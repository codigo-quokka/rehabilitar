...
public class SeedingService : ISeedingService
{
    ...
    public async Task SeedAsync()
    {
        ...
        await SeedActividadAsync("Recuperación Funcional", "Ejercicios para la recuperación de funciones motoras", TipoEspecialidad.TrenInferior, FrecuenciaActividad.Esporadica, EstadoActividad.Aprobada, now.AddHours(9), 10, salaE.Id, natasha.UserId);
        ...
        await SeedActividadRecurrenteAsync("Rehabilitación de Rodilla", "Ejercicios para recuperación de rodilla", TipoEspecialidad.TrenInferior, EstadoActividad.Aprobada, now.AddHours(8), 12, 1000, salaE.Id, clark.UserId, now.AddHours(8).AddDays(30));
