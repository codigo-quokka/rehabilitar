...
public class SeedingService : ISeedingService
{
    ...
    public async Task SeedAsync()
    {
        ...
        try
        {
            ...
            await SeedActividadAsync("Fortalecimiento Lumbar", "Prevención y recuperación de lesiones lumbares", TipoEspecialidad.TrenMedio, FrecuenciaActividad.Esporadica, EstadoActividad.Aprobada, DateTime.Now.AddHours(0), 25, salaD.Id, peter.UserId);
